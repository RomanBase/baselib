...
public class FileHelper {
    ...
    public static void saveInternal(String file, byte[] bytes){
        ...
        try {
            BufferedOutputStream bos = new BufferedOutputStream(Base.context.openFileOutput(file, Context.MODE_PRIVATE));
    ...
    public static byte[] loadInternal(String file){
        ...
        if(existInternal(file, false)){
            try {
                FileInputStream is = Base.context.openFileInput(file);
	...
	public static boolean existInternal(String file, boolean createIfNotExist){
		...
		File outFile = Base.context.getFileStreamPath(file);
		if(outFile.exists()){
			return true;
		} else {
            if(createIfNotExist){
    ...
    public static String[] internalFiles(){
        ...
        return Base.context.getFilesDir().list(null);
    }
    ...
    public static String[] internalFiles(FilenameFilter filter){
        ...
        return Base.context.getFilesDir().list(filter);
    }
    ...
    public static String resourceString(int resourceId){
        ...
        return Base.context.getResources().getString(resourceId);
    }
    ...
    public static void sdWritePrivateFile(String dir, String path, byte[] bytes){
        ...
        if (sdIsWriteable()) {
            try {
                ...
                File file = new File(Base.context.getExternalFilesDir(dir), path);
